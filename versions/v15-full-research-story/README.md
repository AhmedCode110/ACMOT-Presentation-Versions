# AC-MOT — Interactive Master's Presentation (v15)

Open `index.html` in a browser. No internet or libraries needed.

## Content
93 main slides (16:9, 1600 × 900) in ten sections: Introduction & metrics · Related work · Problem & baseline ·
AC-MOT · Setup & first result · V1 optimization · V2 multi-objective · Statistics & UAVDT ·
Literature comparison & protocol audit · Conclusion.
...
- `tools/` — build scripts (`build_v9.py`, `build_v10.py`, `build_v11.py`, `build_v12.py`, `build_v13.py`, `build_v14.py`, `build_v15.py`, `gen_figures.py`)
...
16,592 frames, zero tuning) · paired bootstrap · DroneMOT (ICRA 2024) ByteTrack for the literature comparison.
All AC-MOT results use the custom class-agnostic AC-MOT protocol — not official VisDrone numbers; the official re-evaluation is pending.
