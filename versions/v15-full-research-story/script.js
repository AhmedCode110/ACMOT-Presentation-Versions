...
(function () {
  ...
  var ABBR_SKIP = 'svg,.code,.formula,.s-foot,.notes,.s-head,h1,.qmark,.dv-num,.tabs,.lbl,.kpi .v,.big,.cap,[data-bind],.abbr-x,.prov,.newtag,.adapt,.lock,#u2setup,.ol-card .n,.ol-ppt,.tbl th,.node small';
  ...
  var CHARTS = {
    ...
    'pareto': function (h) {
      ...
      pts.push({ x: D.v1.oldA3val.ids, y: D.v1.oldA3val.mota, color: '#94A3B8', shape: 'diamond', r: 7, label: 'Initial AC-MOT (Old-A3) reference', dx: 14, dy: 22 });
