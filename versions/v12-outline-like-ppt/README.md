# AC-MOT — Interactive Master's Presentation (v12)
...
17 optional explanation topics (60 pages) open from footer buttons and always start at part 1.
...
- `tools/` — build scripts (`build_v9.py`, `build_v10.py`, `build_v11.py`, `build_v12.py`, `gen_figures.py`)
