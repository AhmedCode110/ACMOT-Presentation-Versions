# AC-MOT — Interactive Master's Presentation (v36)

Open `index.html` in a browser. No internet or libraries needed.

## Content
104 main slides (16:9, 1600 × 900) in ten sections: Introduction & metrics · Related work (incl. detectors through the ages) ·
