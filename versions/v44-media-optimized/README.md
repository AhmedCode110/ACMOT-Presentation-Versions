# AC-MOT — Interactive Master's Presentation (v44)
...
## v41 addition
The baseline slide now includes bar charts for quality, identity switches and speed.

## v42 addition
The presentation now uses the correct term “cue” everywhere in the visible deck and supporting content.

## v43 addition
The optional SCI frame-preparation explanation now shows two separate paths: previous detection boxes produce
Crowd and Tiny, while the 25% grayscale copy produces Edge, Low-light and Blur. It explains 0.25 × 0.25 = 6.25%
of the original pixels and states that the visual thresholds use the same preprocessing domain.

## v44 addition
The presentation content is unchanged from v43. The five MP4 videos were re-encoded for smaller web files, and the
largest still images were resized to a maximum width or height of 1600 pixels. File names and media paths stay the
same, so the slide behavior and controls remain unchanged while the GitHub Pages version loads faster.
