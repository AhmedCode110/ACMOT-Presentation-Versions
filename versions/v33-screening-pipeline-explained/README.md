# AC-MOT — Interactive Master's Presentation (v33)

Open `index.html` in a browser. No internet or libraries needed.

## Content
97 main slides (16:9, 1600 × 900) in nine sections: Introduction & metrics · Related work (incl. detectors through the ages) ·
