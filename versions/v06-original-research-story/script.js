...
(function () {
  ...
  var ABBR_SKIP = 'svg,.code,.formula,.s-foot,.notes,.s-head,h1,.qmark,.dv-num,.tabs,.lbl,.kpi .v,.big,.cap,[data-bind],.abbr-x,.prov,.newtag,.adapt,.lock,#u2setup,.ol-card .n,.node small';
