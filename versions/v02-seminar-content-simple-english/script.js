...
(function () {
  ...
  /* ------------------------------------------------ footers (+ Explain button) */
  var EX = window.EXPLAIN || {};
  slides.forEach(function (s, i) {
    var f = $('.s-foot', s);
    if (!f) { f = document.createElement('footer'); f.className = 's-foot'; s.appendChild(f); }
    if (EX[s.getAttribute('data-title')]) {
      var eb = document.createElement('button');
      eb.type = 'button'; eb.className = 'ex-btn'; eb.title = 'Simple explanation and example (E)';
      eb.innerHTML = '<span class="ex-i">i</span>Explain + example';
      f.appendChild(eb);
    }
  ...
  ui.innerHTML =
    ...
    '<div class="bar">' +
      ...
      '<button class="ex-bar" data-act="explain" title="Explain + example (E)" aria-label="Explain this slide">i</button>' +
  ...
  help.innerHTML = '<div class="help-box"><h2 style="margin:0 0 12px">Keyboard controls</h2><table>' +
    ...
    '<tr><td><kbd>E</kbd></td><td>Explain this slide simply, with an example</td></tr>' +
  ...
  document.addEventListener('keydown', function (e) {
    ...
    if (k === 'e' || k === 'E') { toggleExplain(); return; }
