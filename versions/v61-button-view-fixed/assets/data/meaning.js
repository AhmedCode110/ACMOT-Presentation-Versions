...
window.MEANING = {
  ...
  'SCI from frame to score': {
    t: 'Seven small steps turn a video frame into <b>one stable difficulty number</b>: shrink it, measure five cues, mix them, keep the result between 0 and 1, and average the last readings.' },
  'Step 1: measure scene complexity': {
    t: 'SCI looks at <b>five cheap cues</b>: crowded, tiny, busy, dark and blurred. The <b>methods</b> are published; the <b>limits are our own design constants</b>, and the <b>first weights were set by hand</b> (V1 later learned new weights).' },
  'Three cues on real pictures': {
  ...
  'SCI example 0.63': {
    t: 'To get SCI, <b>multiply each cue by its weight and add them up</b>. Here a crowded, tiny and dark scene gives <b>0.63 — a hard frame</b>.' },
