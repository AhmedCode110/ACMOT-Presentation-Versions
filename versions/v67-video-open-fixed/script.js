...
(function () {
  ...
  function openMedia(i) {
    ...
    player.innerHTML = '<video controls playsinline preload="metadata" data-src="' + mediaItems[mediaIndex][1] + '"></video>';
    var v = $('video', player); v.src = v.getAttribute('data-src'); v.removeAttribute('data-src');
  ...
  if (mview) {
    ...
    $('.mfull', mview).addEventListener('click', function () {
  ...
  function closeOverlays() {
    ...
    if (mview) $$('video', mview).forEach(function (v) { v.pause(); });
    hideTip(true);
  }
